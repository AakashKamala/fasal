    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="https://blog.fasal.co/" className="text-gray-700 hover:text-green-700 transition-colors">Fasal</a>
      ...
      <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} bg-white shadow-md`}>
        <div className="container mx-auto px-4 py-4 space-y-4">
          ...
          <a href="https://blog.fasal.co/" className="block text-gray-700 hover:text-green-700 transition-colors">Fasal</a>
